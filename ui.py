...
def show_all_info():
    ...
    for arty in global_variables.artists_list:
        message(arty)
    message('###########  Items Records  ############')
    for item in global_variables.items_list:
        message(item)
    message('###########  Show Records  ############')
    for show in global_variables.show_list:
        message(show)
    message('###########  Sales Records  ############')
    for sale in global_variables.sales_list:
        message(sale)
...
def input_artists_info():
    ...
    update_ind = global_variables.ADD
    art = Artists(firstname, lastname, update_ind)
    global_variables.artists_list.append(art)
...
def input_art_items_info():
    ...
    global_variables.items_list.append(item)
